...
<?php if($hasilSearchSurat!=null){?>
  ...
  <tr style="color:black">
    ...
    <a href="<?= base_url();?>Surat/Lihat_Surat/<?=$hss['id_surat'];?>" class="btn btn-primary">Lihat >></a></td> </tr>  
  <?php endforeach;?>  
  <?php
    } 
    else { ?>
...
<a href="<?= base_url();?>Surat/FormArsipSurat" class="button"
 style="padding-left:10px;padding-right:10px;text-decoration:none;color: 
 #000;background-color: #fff;border: 2px solid black; border-color:black;
  box-shadow: 0px 8px 15px rgba(0, 0, 0, 0.1);"> Arsipkan Surat .. </a>
  </div>
  </div>
